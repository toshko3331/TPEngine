...
H = $(SRC)Bitmap.h $(SRC)ErrorReport.h $(SRC)Vector3.h $(SRC)Window.h
CPP = $(SRC)Bitmap.cpp $(SRC)ErrorReport.cpp $(SRC)Vector3.cpp $(SRC)Window.cpp $(SRC)Main.cpp
#Directory to include
INCLUDE = $(shell sdl2-config --cflags)
#Linking Directories
LDFLAGS = $(shell sdl2-config --libs)

OBJECTS = $(BUILD_DIR)Main.o $(BUILD_DIR)Bitmap.o $(BUILD_DIR)Vector3.o $(BUILD_DIR)Window.o
